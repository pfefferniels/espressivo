...
| `tempo`               | **ln(1.025) ≈ 0.0247 nepers** | **[literature]** — the >2 % local-slowing threshold used to classify a ritardando, and Sundberg/Friberg/Frydén 1991's near-threshold preferred k-values. AD-27.6 halved revision 2's ln(1.05) [convention] onto that support; this row said ln(1.05) until W3 MAJOR-5 found it contradicting the ruling AND the shipped constant by 2× |
