...
export class Pitches {
    ...
    addFeatureAt(index: number, feature: FeatureVector): boolean {
        ...
        if (feature.getSize() !== this.key.getSize()) {
            console.error("Error: Dimensions of key and feature vector do not match. It cannot be added to the pitch features.");
            return false;
        }
     ...
     * @return
     */
    getAsString(prettyPrint: boolean = false): string {
