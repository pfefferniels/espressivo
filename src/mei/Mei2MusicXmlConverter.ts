...
// Enums
enum StartStop { START = 'start', STOP = 'stop' }
enum StartStopContinue { START = 'start', STOP = 'stop', CONTINUE = 'continue' }
enum YesNo { YES = 'yes', NO = 'no' }
enum AboveBelow { ABOVE = 'above', BELOW = 'below' }
enum OverUnder { OVER = 'over', UNDER = 'under' }
enum BackwardForward { BACKWARD = 'backward', FORWARD = 'forward' }
enum RightLeftMiddle { RIGHT = 'right', LEFT = 'left', MIDDLE = 'middle' }
enum StemValue { UP = 'up', DOWN = 'down', NONE = 'none', DOUBLE = 'double' }
enum ClefSign { G = 'G', F = 'F', C = 'C', PERCUSSION = 'percussion', TAB = 'TAB', JIANPU = 'jianpu', NONE = 'none' }
enum TimeSymbol { COMMON = 'common', CUT = 'cut', SINGLE_NUMBER = 'single-number', NOTE = 'note', DOTTED_NOTE = 'dotted-note', NORMAL = 'normal' }
enum AccidentalValue {
    SHARP = 'sharp', NATURAL = 'natural', FLAT = 'flat',
    DOUBLE_SHARP = 'double-sharp', SHARP_SHARP = 'sharp-sharp',
    FLAT_FLAT = 'flat-flat', NATURAL_SHARP = 'natural-sharp',
    NATURAL_FLAT = 'natural-flat', QUARTER_FLAT = 'quarter-flat',
    QUARTER_SHARP = 'quarter-sharp', THREE_QUARTERS_FLAT = 'three-quarters-flat',
    THREE_QUARTERS_SHARP = 'three-quarters-sharp'
}
enum Step { A = 'A', B = 'B', C = 'C', D = 'D', E = 'E', F = 'F', G = 'G' }

// Helper to create enum from string value
function enumFromValue<T extends Record<string, string>>(enumObj: T, value: string): T[keyof T] | undefined {
...
class Work {
    ...
    getWorkTitle(): string | null { return this.workTitle; }
    setWorkTitle(v: string) { this.workTitle = v; }
    getWorkNumber(): string | null { return this.workNumber; }
    setWorkNumber(v: string) { this.workNumber = v; }
}
...
class Encoding {
    ...
    getEncodingDateOrEncoderOrSoftware(): JAXBElement<TypedText>[] { return this.encodingDateOrEncoderOrSoftware; }
}
...
class Identification {
    ...
    getEncoding(): Encoding | null { return this.encoding; }
    setEncoding(v: Encoding) { this.encoding = v; }
    getCreator(): TypedText[] { return this.creator; }
    getSource(): string | null { return this.source; }
    setSource(v: string) { this.source = v; }
    getMiscellaneous(): Miscellaneous | null { return this.miscellaneous; }
    setMiscellaneous(v: Miscellaneous) { this.miscellaneous = v; }
}

class Miscellaneous {
    miscellaneousField: MiscellaneousField[] = [];
    getMiscellaneousField(): MiscellaneousField[] { return this.miscellaneousField; }
}
...
class EmptyFont {
    ...
    setFontFamily(v: string) { this.fontFamily = v; }
}
...
class PageLayout {
    ...
    getPageHeight(): number | null { return this.pageHeight; }
    setPageHeight(v: number) { this.pageHeight = v; }
    getPageWidth(): number | null { return this.pageWidth; }
    setPageWidth(v: number) { this.pageWidth = v; }
    getPageMargins(): PageMargins[] { return this.pageMargins; }
}
...
class PageMargins {
    ...
    setLeftMargin(v: number) { this.leftMargin = v; }
    setRightMargin(v: number) { this.rightMargin = v; }
    setTopMargin(v: number) { this.topMargin = v; }
    setBottomMargin(v: number) { this.bottomMargin = v; }
}
...
class SystemLayout {
    ...
    getSystemDistance(): number | null { return this.systemDistance; }
    setSystemDistance(v: number) { this.systemDistance = v; }
    getTopSystemDistance(): number | null { return this.topSystemDistance; }
    setTopSystemDistance(v: number) { this.topSystemDistance = v; }
}
...
class StaffLayout {
    ...
    setStaffDistance(v: number) { this.staffDistance = v; }
}
...
class Defaults {
    ...
    getPageLayout(): PageLayout | null { return this.pageLayout; }
    setPageLayout(v: PageLayout) { this.pageLayout = v; }
    getSystemLayout(): SystemLayout | null { return this.systemLayout; }
    setSystemLayout(v: SystemLayout) { this.systemLayout = v; }
    getStaffLayout(): StaffLayout[] { return this.staffLayout; }
    getMusicFont(): EmptyFont | null { return this.musicFont; }
    setMusicFont(v: EmptyFont) { this.musicFont = v; }
    getWordFont(): EmptyFont | null { return this.wordFont; }
    setWordFont(v: EmptyFont) { this.wordFont = v; }
    getLyricFont(): LyricFont[] { return this.lyricFont; }
}
...
class Credit {
    ...
    getCreditTypeOrLinkOrBookmark(): any[] { return this.creditTypeOrLinkOrBookmark; }
    getPage(): number | null { return this.page; }
    setPage(v: number) { this.page = v; }
}
...
class ScorePart {
    ...
    getPartName(): PartName | null { return this.partName; }
    setPartName(v: PartName) { this.partName = v; }
    setPartAbbreviation(v: PartName) { this.partAbbreviation = v; }
}

class PartGroup {
    type: StartStop | null = null;
    setType(v: StartStop) { this.type = v; }
    getType(): StartStop | null { return this.type; }
}

class PartList {
    partGroupOrScorePart: any[] = [];
    getPartGroupOrScorePart(): any[] { return this.partGroupOrScorePart; }
}
...
class Pitch {
    ...
    getStep(): Step | null { return this.step; }
    setStep(v: Step) { this.step = v; }
    getAlter(): number | null { return this.alter; }
    setAlter(v: number) { this.alter = v; }
    getOctave(): number | null { return this.octave; }
    setOctave(v: number) { this.octave = v; }
}

class Rest {
    measure: YesNo | null = null;
    getMeasure(): YesNo | null { return this.measure; }
    setMeasure(v: YesNo) { this.measure = v; }
}
...
class Accidental {
    ...
    getValue(): AccidentalValue | null { return this.value; }
    setValue(v: AccidentalValue) { this.value = v; }
}

class EmptyPlacement {
    placement: AboveBelow | null = null;
    setPlacement(v: AboveBelow) { this.placement = v; }
}

class Stem {
    value: StemValue | null = null;
    getValue(): StemValue | null { return this.value; }
    setValue(v: StemValue) { this.value = v; }
}
...
class TimeModification {
    ...
    setActualNotes(v: number) { this.actualNotes = v; }
    setNormalNotes(v: number) { this.normalNotes = v; }
}
...
class Tied {
    ...
    getType(): StartStopContinue | null { return this.type; }
    setType(v: StartStopContinue) { this.type = v; }
    setOrientation(v: OverUnder) { this.orientation = v; }
    setPlacement(v: AboveBelow) { this.placement = v; }
}
...
class Tuplet {
    ...
    setBracket(v: YesNo) { this.bracket = v; }
    setType(v: StartStop) { this.type = v; }
}

class Notations {
    tiedOrSlurOrTuplet: any[] = [];
    getTiedOrSlurOrTuplet(): any[] { return this.tiedOrSlurOrTuplet; }
}
...
class MusicXmlNote {
    ...
    getVoice(): string | null { return this.voice; }
    setVoice(v: string) { this.voice = v; }
    getRest(): Rest | null { return this.rest; }
    setRest(v: Rest) { this.rest = v; }
    getPitch(): Pitch | null { return this.pitch; }
    setPitch(v: Pitch) { this.pitch = v; }
    getDuration(): number | null { return this.duration; }
    setDuration(v: number) { this.duration = v; }
    getType(): NoteType | null { return this.type; }
    setType(v: NoteType) { this.type = v; }
    getAccidental(): Accidental | null { return this.accidental; }
    setAccidental(v: Accidental) { this.accidental = v; }
    setPrintObject(v: YesNo) { this.printObject = v; }
    setPrintDot(v: YesNo) { this.printDot = v; }
    getDot(): EmptyPlacement[] { return this.dot; }
    getStem(): Stem | null { return this.stem; }
    setStem(v: Stem) { this.stem = v; }
    setChord(v: Empty) { this.chord = v; }
    getTimeModification(): TimeModification | null { return this.timeModification; }
    setTimeModification(v: TimeModification) { this.timeModification = v; }
    getTie(): Tie[] { return this.tie; }
    getNotations(): Notations[] { return this.notations; }
}
...
class Clef {
    ...
    setSign(v: ClefSign) { this.sign = v; }
    setLine(v: number) { this.line = v; }
    setClefOctaveChange(v: number) { this.clefOctaveChange = v; }
}

class Key {
    fifths: number | null = null;
    setFifths(v: number) { this.fifths = v; }
}
...
class Time {
    ...
    setSymbol(v: TimeSymbol) { this.symbol = v; }
    getTimeSignature(): JAXBElement<string>[] { return this.timeSignature; }
}
...
class Attributes {
    ...
    getDivisions(): number | null { return this.divisions; }
    setDivisions(v: number) { this.divisions = v; }
...
class Barline {
    ...
    setLocation(v: RightLeftMiddle) { this.location = v; }
    setRepeat(v: Repeat) { this.repeat = v; }
}

class Repeat {
    direction: BackwardForward | null = null;
    setDirection(v: BackwardForward) { this.direction = v; }
}
...
class ScorePartwisePartMeasure {
    ...
    setNumber(v: string) { this.number = v; }
    getNoteOrBackupOrForward(): any[] { return this.noteOrBackupOrForward; }
}
...
class ScorePartwisePart {
    ...
    getId(): any { return this.id; }
    setId(v: any) { this.id = v; }
    getMeasure(): ScorePartwisePartMeasure[] { return this.measure; }
}
...
class ScorePartwise {
    ...
    getWork(): Work | null { return this.work; }
    setWork(v: Work) { this.work = v; }
    getMovementNumber(): string | null { return this.movementNumber; }
    setMovementNumber(v: string) { this.movementNumber = v; }
    getMovementTitle(): string | null { return this.movementTitle; }
    setMovementTitle(v: string) { this.movementTitle = v; }
    getIdentification(): Identification | null { return this.identification; }
    setIdentification(v: Identification) { this.identification = v; }
    getDefaults(): Defaults | null { return this.defaults; }
    setDefaults(v: Defaults) { this.defaults = v; }
    getCredit(): Credit[] { return this.credit; }
    getPartList(): PartList | null { return this.partList; }
    setPartList(v: PartList) { this.partList = v; }
    getVersion(): string | null { return this.version; }
    setVersion(v: string) { this.version = v; }
    getPart(): ScorePartwisePart[] { return this.part; }
}
...
class ScoreTimewiseMeasure {
    ...
    getNumber(): string { return this.number; }
    setNumber(v: string) { this.number = v; }
    getPart(): ScoreTimewiseMeasurePart[] { return this.part; }
}
...
class ScoreTimewise {
    ...
    getVersion(): string | null { return this.version; }
    setVersion(v: string) { this.version = v; }
    getMeasure(): ScoreTimewiseMeasure[] { return this.measure; }
}
...
class DefinitionType {
    ...
    getNumRatio(): string | null {
        if (this.numDefault !== null && this.numDefault !== '' && this.numBaseDefault !== null && this.numBaseDefault !== '') {
    ...
    getClefDis(): string | null { return this.clefDis; }
    ...
    getClefDisPlace(): string | null { return this.clefDisPlace; }
    ...
    getClefLine(): string | null { return this.clefLine; }
    ...
    getClefShape(): string | null { return this.clefShape; }
    ...
    getKeySig(): string | null { return this.keySigVal; }
    ...
    getOctDefault(): string | null { return this.octDefault; }
    ...
    getPpq(): string | null { return this.ppq; }
    ...
    getDurDefault(): string | null { return this.durDefault; }
    ...
    getMeterSym(): string | null { return this.meterSym; }
    ...
    getMeterCount(): string | null { return this.meterCount; }
    ...
    getMeterUnit(): string | null { return this.meterUnit; }
    ...
    getNumDefault(): string | null { return this.numDefault; }
    ...
    getNumBaseDefault(): string | null { return this.numBaseDefault; }
    ...
    isFull(): boolean {
        const fields: (string | null)[] = [
            this.clefDis, this.clefDisPlace, this.clefLine, this.clefShape,
            this.keySigVal, this.octDefault, this.ppq, this.durDefault,
            this.label, this.meterSym, this.meterCount, this.meterUnit,
            this.n, this.numDefault, this.numBaseDefault
        ];
    ...
    hashCode(): number {
        // Simple hash for TS
        let hash = 0;
        const fields = [this.clefDis, this.clefDisPlace, this.clefLine, this.clefShape,
            this.keySigVal, this.octDefault, this.ppq, this.durDefault,
            this.label, this.meterCount, this.meterUnit, this.n,
            this.numDefault, this.numBaseDefault];
    ...
    hasSubset(ofThis: DefinitionType): boolean {
        ...
        b = this.checkAndSetDifference(this.clefDis, ofThis.clefDis, b, (v) => this.diff!.setClefDis(v));
        b = this.checkAndSetDifference(this.clefDisPlace, ofThis.clefDisPlace, b, (v) => this.diff!.setClefDisPlace(v));
        b = this.checkAndSetDifference(this.clefLine, ofThis.clefLine, b, (v) => this.diff!.setClefLine(v));
        b = this.checkAndSetDifference(this.clefShape, ofThis.clefShape, b, (v) => this.diff!.setClefShape(v));
        b = this.checkAndSetDifference(this.keySigVal, ofThis.keySigVal, b, (v) => this.diff!.setKeySig(v));
        b = this.checkAndSetDifference(this.octDefault, ofThis.octDefault, b, (v) => this.diff!.setOctDefault(v));
        b = this.checkAndSetDifference(this.ppq, ofThis.ppq, b, (v) => this.diff!.setPpq(v));
        b = this.checkAndSetDifference(this.durDefault, ofThis.durDefault, b, (v) => this.diff!.setDurDefault(v));
        b = this.checkAndSetDifference(this.label, ofThis.label, b, (v) => this.diff!.setLabel(v));
        b = this.checkAndSetDifference(this.meterSym, ofThis.meterSym, b, (v) => this.diff!.setMeterSym(v));
        b = this.checkAndSetDifference(this.meterCount, ofThis.meterCount, b, (v) => this.diff!.setMeterCount(v));
        b = this.checkAndSetDifference(this.meterUnit, ofThis.meterUnit, b, (v) => this.diff!.setMeterUnit(v));
        b = this.checkAndSetDifference(this.n, ofThis.n, b, (v) => this.diff!.setN(v));
        b = this.checkAndSetDifference(this.numDefault, ofThis.numDefault, b, (v) => this.diff!.setNumDefault(v));
        b = this.checkAndSetDifference(this.numBaseDefault, ofThis.numBaseDefault, b, (v) => this.diff!.setNumBaseDefault(v));
     ...
     */
    private checkAndSetDifference(thisField: string | null, otherField: string | null, currentStatus: boolean, setter: (v: string | null) => void): boolean {
...
export class Mei2MusicXmlConverter {
    ...
    private pwIsCurrent: boolean = false;
    private twIsCurrent: boolean = false;
    ...
    convert(mei: Mei): MusicXml[] {
        try {
            ...
            if (this.mxmls.length === 1)
                this.mxmls[0].setFile(Helper.getFilenameWithoutExtension(this.mei.getFile()!) + ".musicxml");
            else if (this.mxmls.length > 1) {
                for (let i = 0; i < this.mxmls.length; ++i) {
                    this.mxmls[i].setFile(Helper.getFilenameWithoutExtension(this.mei.getFile()!) + "-" + i + ".musicxml");
                }
            }

            // cleanup
            this.mei.setDocument(orig);
            console.log("MEI to MusicXML conversion finished. Time consumed: " + (Date.now() - startTime) + " milliseconds");
            return this.mxmls;
        } catch (e) {
            console.error(e);
            return this.mxmls;
                ...
                case "staffDef":
                    if (this.twIsCurrent) {
                        ...
                        if (scoreDef !== null) {
                            ...
                            if (Helper.getPreviousSiblingElement("scoreDef", e) !== null || Helper.getPreviousSiblingElement("staffDef", e) !== null || Helper.getParentElement(e)!.getLocalName() === "section") {
                                break;
                            }
                        }
                    }
    ...
    private addTypedTextToEncoding(value: string, typeVal: string | null, qnameString: string): void {
        ...
        this.header.getIdentification()!.getEncoding()!.getEncodingDateOrEncoderOrSoftware().push(
            new JAXBElement<TypedText>(qnameString, 'TypedText', tt)
        );
    }
    ...
    private processTitle(title: Element): void {
        ...
        if ((title.getLocalName() === "title" && (attr === null || attr === '')) || title.getLocalName() === "identifier") { attr = "main"; }
        ...
        switch (attr) {
            ...
            case "subordinate": {
                ...
                if (!hasFound) {
                    if (this.header.getWork()!.getWorkTitle() !== null && this.header.getWork()!.getWorkTitle() === value) break;
    ...
    private processChoice(choice: Element, processInHeader: boolean): void {
        ...
        if (c !== null) {
            if (c.getLocalName() === "choice")
                this.processChoice(c, processInHeader);
            else
                this.convertByFlag(c, processInHeader);
            return;
        }
        ...
        if (children.size() > 0) {
            ...
            if (first !== null)
                this.convertByFlag(first, processInHeader);
        }
    }
    ...
    private cloneScore(score: ScorePartwise): ScorePartwise | null {
        try {
            ...
            return JSON.parse(JSON.stringify(score, (key, value) => {
    ...
    private cloneScorePartwise(score: ScorePartwise): ScorePartwise {
        ...
        if (score.identification) {
            ...
            if (score.identification.encoding) {
                ...
                copy.identification.encoding.encodingDateOrEncoderOrSoftware = [...score.identification.encoding.encodingDateOrEncoderOrSoftware];
            }
            ...
            if (score.identification.miscellaneous) {
                ...
                copy.identification.miscellaneous.miscellaneousField = [...score.identification.miscellaneous.miscellaneousField];
            }
        }
        if (score.defaults) {
    ...
    private processMisc(e: Element, readValue: boolean): void {
        ...
        let misc = this.header.getIdentification()!.getMiscellaneous();
        if (misc === null) {
    ...
    private processPgHead(pgHead: Element): void {
        ...
        if (title.size() > 0) {
            ...
            if (!hasTit) this.header.getWork()!.setWorkTitle((title.get(0) as unknown as Element).getValue().trim());
        }
    ...
    processStaffTW(staff: Element): void {
        ...
        if (staffN !== null) {
            ...
            const staffIdx = Helper.getAllChildElements("staff", Helper.getParentElement(staff)!)!.indexOf(staff);
            if (staffIdx >= 0) {
        ...
        if (sp === null) {
            ...
            this.currentScoreTimewise!.getPartList()!.getPartGroupOrScorePart().splice(idx + 1, 0, scorePart);
            sp = scorePart;
        }
    ...
    private addObjectToMeasureOrPart(o: any): void {
        const allowedTypes = [MusicXmlNote, Backup, Forward, Direction, Attributes, Harmony, FiguredBass, Print, Sound, Barline, Grouping, Link, Bookmark];
        let doAdd = false;
    ...
    private isPrevAttributeDifferent(e: Element): boolean {
        ...
        if (prevMeasure === null && section.getLocalName() === "section" && Helper.getFirstChildElement("measure", section) === parentMeasure) {
            ...
            if (prevSection !== null) {
                ...
                measureChildren = (measureChildren === null || measureChildren.length === 0) ? Helper.getAllDescendantsByName("measure", prevSection) : measureChildren;
                if (measureChildren !== null && measureChildren.length > 0) prevMeasure = measureChildren[measureChildren.length - 1];
            }
        }
        ...
        if (prevDefinition !== null && currentDef !== null) {
            ...
            if (!b) {
                ...
                if (this.defDiff !== null && (this.defDiff.getMeterCount() !== null || this.defDiff.getMeterUnit() !== null || this.defDiff.getMeterSym() !== null)) {
    ...
    private addEmptyFontDefaults(fontname: string | null, targetElement: string): void {
        ...
        if (targetElement === "music-font") { this.header.getDefaults()!.setMusicFont(emptyFont); }
        if (targetElement === "word-font") { this.header.getDefaults()!.setWordFont(emptyFont); }
    }
    ...
    private addLyricFontDefaults(fontname: string | null): void {
        ...
        if (fontname !== null && fontname !== '') { this.header.getDefaults()!.getLyricFont().push(lyricFont); }
    }

    /**
     * Process layout information to set defaults.
     */
    private addLayoutDefault(value: string | null, targetElement: string, layoutPrefix: string): void {
    ...
    createAttributesFromElement(e: Element): Attributes | null {
        const clefLine = e.getLocalName() === "clef" ? e.getAttributeValue("line") : e.getAttributeValue("clef.line");
        const clefShape = e.getLocalName() === "clef" ? e.getAttributeValue("shape") : e.getAttributeValue("clef.shape");
        const dis = e.getLocalName() === "clef" ? e.getAttributeValue("dis") : e.getAttributeValue("clef.dis");
        const disPlace = e.getLocalName() === "clef" ? e.getAttributeValue("disPlace") : e.getAttributeValue("clef.dis.place");
        const meterSym = e.getAttributeValue("meter.sym");
        const meterCount = e.getLocalName() === "meterSig" ? e.getAttributeValue("count") : e.getAttributeValue("meter.count");
        const meterUnit = e.getLocalName() === "meterSig" ? e.getAttributeValue("unit") : e.getAttributeValue("meter.unit");
        const keySig = e.getLocalName() === "keySig" ? e.getAttributeValue("sig") : e.getAttributeValue("key.signature");
     ...
     */
    private createAttributes(clefLine: string | null, clefShape: string | null, dis: string | null, disPlace: string | null, meterSym: string | null, meterCount: string | null, meterUnit: string | null, keySig: string | null): Attributes | null {
        ...
        if (addClef) attributes.getClef().push(clef); doReturn = true;
        ...
        if (addTime) attributes.getTime().push(time); doReturn = true;
    ...
    private createNote(e: Element): MusicXmlNote | null {
        ...
        switch (e.getLocalName()) {
            ...
            case "note": {
                ...
                const stem = new Stem();
                const stemDir = parentChord !== null ? parentChord.getAttributeValue("stem.dir") : e.getAttributeValue("stem.dir");
        ...
        let elementWithDuration = (e.getAttributeValue("dur") === null || e.getAttributeValue("dur") === '') && closestWithDuration !== null ? closestWithDuration : e;
    ...
    private processTuplet(note: MusicXmlNote, e: Element): void {
        ...
        if (parentTuplet !== null) {
            ...
            numbase = (numbase === null || numbase === '') && (numInt & (numInt - 1)) === 0 ? "" + numInt : "" + (this.highestOneBit(numInt));
     ...
     */
    private addTimeModification(note: MusicXmlNote, num: string, numbase: string, isFirst: boolean, isLast: boolean): void {
    ...
    private findCorrespondingDefinition(e: Element): DefinitionType {
        ...
        if (targetElement.getLocalName() === "staff") {
            ...
            staffN = (staffN === null || staffN === '') ? "" + (Helper.getAllChildElements("staff", Helper.getParentElement(targetElement)!)!.indexOf(targetElement) + 1) : staffN;
            this.setStaffDefOrLayerDefToDtype(dType, targetElement);
            targetElement = Helper.getParentElement(targetElement)!;
        }
        ...
        do {
            if (targetElement!.getLocalName() === "section") {
                ...
                if (prevSection !== null) {
                    let prevMeasures = Helper.getAllChildElements("measure", prevSection) ?? [];
                    let prevMeasure: Element | null = null;
                    if (prevMeasures.length > 0) {
                        prevMeasures.reverse();
                        prevMeasure = prevMeasures[0];
                    }
                    let staffDefCandidates = Helper.getAllChildElements("staffDef", prevSection) ?? [];
    ...
    private setStaffDefOrLayerDefToDtype(dType: DefinitionType, targetElement: Element): void {
        ...
        if (staffDef !== null) {
            ...
            for (const ch of staffDefChildren!) {
                ...
                try {
                    if (ch.getLocalName() === "layerDef" && ch.getAttributeValue("n") === targetElement.getAttributeValue("n")) {
