...
export class DynamicsDef extends AbstractDef {
    ...
    static getDefaultVolumeLevel(dynamics: string): number {
        switch (dynamics.trim().toLowerCase()) {
            case "pppp": case "pianissimopianissimo": return 5.0;
            case "ppp": case "pianopianissimo": return 12.0;
            case "pp": case "pianissimo": return 36.0;
            case "p": case "piano": return 48.0;
            case "mp": case "mezzopiano": return 64.0;
            case "mf": case "mezzoforte": return 83.0;
            case "f": case "forte": return 97.0;
            case "ff": case "fortissimo": return 111.0;
            case "fff": case "fortefortissimo": return 120.0;
            case "ffff": case "fortissimofortissimo": return 125.0;
            case "sf": case "sfz": case "fz": case "sforzato": return 127.0;
            default: return 74.0;
        }
    }
}
