...
export class MetricalAccentuationStyle extends GenericStyle<AccentuationPatternDef> {
    ...
    static createMetricalAccentuationStyle(name: string, id: string): MetricalAccentuationStyle | null;
    static createMetricalAccentuationStyle(xml: Element): MetricalAccentuationStyle | null;
    static createMetricalAccentuationStyle(nameOrXml: string | Element, id?: string): MetricalAccentuationStyle | null {
        try {
