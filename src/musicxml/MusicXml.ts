...
export class MusicXml extends XmlBase {
    ...
    static toScorePartwiseDocument(scoreTimewise: Document): Document | null {
        ...
        switch (rootName) {
            ...
            default:
                console.log("A " + rootName + " document cannot be converted into a score-partwise representation.");
                return null;
        }
    ...
    toScorePartwise(): MusicXml | null {
        ...
        if (type === MusicXmlType.scorePartwise)
            return this;

        if (type === MusicXmlType.opus)
            return null;
    ...
    toScoreTimewise(): MusicXml | null {
        ...
        if (type === MusicXmlType.scoreTimewise)
            return this;
    ...
    getType(): MusicXmlType {
        ...
        switch (rootName) {
            case "score-partwise": return MusicXmlType.scorePartwise;
            case "score-timewise": return MusicXmlType.scoreTimewise;
            case "opus": return MusicXmlType.opus;
            default: return MusicXmlType.unknown;
        }
    }
     ...
     * @return
     */
    exportMsmMpm(_ppq: number = 720, _cleanup: boolean = true): null {
    ...
    writeMusicXml(filename?: string): string | null {
        ...
        if (filename !== undefined) {
            ...
            if (ext === ".mxl") {
                console.log("According to the file extension, a Compressed MusicXML should be written. Switching to the corresponding method.");
    ...
    writeCompressedMusicXml(_filename?: string): string | null {
        ...
        console.error("Compressed MusicXML (.mxl) writing is not yet supported in this TypeScript port.");
        return null;
    }
