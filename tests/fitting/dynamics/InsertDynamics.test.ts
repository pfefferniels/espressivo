...
// closed' invariant in tests/fitting/roundtrip/invariants.ts.
...
// Superseded by tests/fitting/roundtrip: 'dynamics: linear crescendo 40 to 100' renders the fit and
