...
import {
  ...
  positionAtDate,
  volumeAtDate,
} from '../../../src/fitting/transformers/dynamics/Approximation.js';
import type { DynamicsWithEndDate } from '../../../src/fitting/transformers/dynamics/InsertDynamicsInstructions.js';
import type { InstructionOptions } from '../../../src/fitting/instructions/index.js';
