...
export const tierTwoCases: Case[] = [
  ...
  },
  {
    ...
    bounds: {
      onset: { mean: 105, max: 260 },
      duration: { mean: 80, max: 140 },
      velocity: { max: 0.5 },
    },
  },
  {
...
export const tierThreeCases: Case[] = [
  ...
  },
  {
    ...
    // what an alignment is and what a render is not. They are covered in tests/fitting/tempo instead.
    note:
      'the tempo fitter runs first, over onsets the rubato has already warped, and a ' +
      'moving tempo gives it more room to explain them away than the steady one above',
    bounds: {
      onset: { mean: 145, max: 410 },
      duration: { mean: 165, max: 290 },
      velocity: { max: 0.5 },
    },
  },
  {
  ...
  },
  {
    ...
    bounds: {
      onset: { mean: 415, max: 750 },
      duration: { mean: 405, max: 980 },
  ...
  },
  {
    ...
    bounds: {
      onset: { mean: 210, max: 490 },
      duration: { mean: 330, max: 1350 },
      velocity: { mean: 17, max: 31 },
    },
  },
];
