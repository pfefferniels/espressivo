import { performMsmToData } from '../../../src/api/pipeline.js';
import type { PerformanceData, PerformedNote } from '../../../src/api/types.js';
import { Alignment } from '../../../src/fitting/alignment.js';
import { createMpm, exportMPM, Mpm } from '../../../src/fitting/instructions/index.js';
import type { Transformer } from '../../../src/fitting/transformers/Transformer.js';
import { compareTransformers } from '../../../src/fitting/transformers/index.js';
import {
...
import { InsertRubato } from '../../../src/fitting/transformers/rubato/InsertRubato.js';
...
} from '../../../src/fitting/transformers/ornamentation/index.js';

import {
  InsertArticulation,
  type ArticulationProperty,
} from '../../../src/fitting/transformers/articulation/InsertArticulation.js';
import { StylizeArticulation } from '../../../src/fitting/transformers/articulation/StylizeArticulation.js';
import {
...
export const chainFor = (spec: Case, msm: Alignment): Transformer[] => {
  ...
  if (spec.truth.tempo?.length) {
    const windows = spec.discoverBoundaries
      ? [{ from: 0, to: end }]
      : fittingWindows(
          spec.truth.tempo.map((span) => span.date),
          end,
        );
