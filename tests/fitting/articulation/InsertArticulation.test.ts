...
import { InsertArticulation } from '../../../src/fitting/transformers/index.js';
...
// tests/fitting/roundtrip/invariants.ts.
...
// for is covered by tests/fitting/roundtrip's tier-1 case 'a uniform legato comes back as one def at
