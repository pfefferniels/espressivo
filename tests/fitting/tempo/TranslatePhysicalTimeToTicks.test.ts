...
import { FrameDomain } from '../../../src/mpm/elements/styles/defs/TemporalSpread.js';
...
import { TranslatePhysicalTimeToTicks } from '../../../src/fitting/transformers/tempo/TranslatePhysicalTimeToTicks.js';
...
test('it translates existing physical modifiers into tick modifiers', () => {
  ...
  // Assert
  const drafts = getInstructions(mpm, 'ornament', 'global').map((arpeggio) =>
    ornamentDraftOf(arpeggio.element),
  );
