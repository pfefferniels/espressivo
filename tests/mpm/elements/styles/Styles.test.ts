...
describe('TempoStyle', () => {
  ...
  it('parses tempoDef children into the lookup table', () => {
    const ts = TempoStyle.createTempoStyle(
...
describe('DynamicsStyle', () => {
  ...
  it('parses dynamicsDef children into the lookup table', () => {
    const ds = DynamicsStyle.createDynamicsStyle(
      styleDefElement('default', [
  ...
  it('skips malformed dynamicsDef children', () => {
    const ds = quiet(() =>
      DynamicsStyle.createDynamicsStyle(
        styleDefElement('default', [
...
describe('ArticulationStyle', () => {
  ...
  it('parses articulationDef children into the lookup table', () => {
    const as = ArticulationStyle.createArticulationStyle(
      styleDefElement('default', [
  ...
  it('skips articulationDef children without a name', () => {
    const as = quiet(() =>
      ArticulationStyle.createArticulationStyle(
        styleDefElement('default', [
  ...
  it('returns null when the name attribute is missing', () => {
    expect(
      quiet(() => ArticulationStyle.createArticulationStyle(element('styleDef', {}))),
    ).toBeNull();
  });
});
...
describe('RubatoStyle', () => {
  ...
  it('parses rubatoDef children into the lookup table', () => {
    const rs = RubatoStyle.createRubatoStyle(
      styleDefElement('default', [
        element('rubatoDef', {
          name: 'gentle',
          frameLength: '720.0',
...
describe('MetricalAccentuationStyle', () => {
  ...
  it('accepts an id as second argument', () => {
    expect(
      MetricalAccentuationStyle.createMetricalAccentuationStyle('default', 'mas-1')!.getId(),
    ).toBe('mas-1');
  });
  ...
  it('skips accentuationPatternDef children without a name', () => {
    const mas = quiet(() =>
      MetricalAccentuationStyle.createMetricalAccentuationStyle(
        styleDefElement('default', [
  ...
  it('returns null when the name attribute is missing', () => {
    expect(
      quiet(() =>
        MetricalAccentuationStyle.createMetricalAccentuationStyle(element('styleDef', {})),
      ),
    ).toBeNull();
  });
});
