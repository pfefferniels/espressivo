...
describe('ArticulationDef', () => {
    describe('createArticulationDef', () => {
        ...
        it('parses every supported attribute from xml', () => {
            const ad = ArticulationDef.createArticulationDef(articulationDefElement({
                name: 'full',
        ...
        it('returns null when the name attribute is missing', () => {
            ...
            expect(ArticulationDef.createArticulationDef(articulationDefElement({ relativeDuration: '0.8' }))).toBeNull();
    ...
    describe('parseData', () => {
        it('re-reads name and attributes when applied to another element', () => {
            ...
            const other = articulationDefElement({ name: 'second', relativeDuration: '0.8', detuneHz: '2.0' });
    ...
    describe('resetAttribute', () => {
        it('removes the attribute and restores the default for every supported name', () => {
            ...
            for (const name of ['absoluteDuration', 'absoluteDurationChange', 'absoluteDurationMs',
    ...
    describe('createDefaultArticulationDef', () => {
        ...
        it('lengthens legatissimo', () => {
            expect(ArticulationDef.createDefaultArticulationDef('legatissimo')!.getAbsoluteDurationChangeMs()).toBe(250.0);
        });
        ...
        it('barely shortens nonlegato', () => {
            expect(ArticulationDef.createDefaultArticulationDef('nonlegato')!.getRelativeDuration()).toBe(0.95);
        });
        ...
        it('shortens the standard articulation by a fixed amount of ticks', () => {
            expect(ArticulationDef.createDefaultArticulationDef('standardArticulation')!.getAbsoluteDurationChange()).toBe(-70.0);
        });
    ...
    describe('articulateNote', () => {
        ...
        it('passes absoluteDurationChangeMs on to the note', () => {
            ...
            const n = note({ 'duration.perf': '360.0' });
            ad.articulateNote(n);
            expect(parseFloat(n.getAttributeValue('articulation.absoluteDurationChangeMs')!)).toBe(-400.0);
        });
