...
describe('MovementMap', () => {
    ...
    describe('Inner control point X positions (via getMovementSegment)', () => {
        ...
        it('high curvature changes the transition shape', () => {
            ...
            md1.startDate = 0; md1.endDate = 1000;
            md1.position = 0.0; md1.transitionTo = 1.0;
            md1.curvature = 0.0; md1.protraction = 0.0;

            const md2 = new MovementData();
            md2.startDate = 0; md2.endDate = 1000;
            md2.position = 0.0; md2.transitionTo = 1.0;
            md2.curvature = 0.5; md2.protraction = 0.0;
    ...
    describe('MovementData.getMovementSegment', () => {
        ...
        it('curve subdivision creates more points for larger transitions', () => {
            ...
            mdSmall.startDate = 0; mdSmall.endDate = 1000;
            mdSmall.position = 0.0; mdSmall.transitionTo = 0.1;
            mdSmall.curvature = 0.0; mdSmall.protraction = 0.0;

            const mdLarge = new MovementData();
            mdLarge.startDate = 0; mdLarge.endDate = 1000;
            mdLarge.position = 0.0; mdLarge.transitionTo = 1.0;
            mdLarge.curvature = 0.0; mdLarge.protraction = 0.0;
