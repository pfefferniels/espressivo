...
describe('AsynchronyMap', () => {
    ...
    describe('renderAsynchronyToMap', () => {
         ...
         */
        function createTestMap(entries: { date: number; msDate: number; duration: number; msEnd: number; id?: string }[]): GenericMap {
        ...
        it('notes without duration attribute are still processed for date', () => {
            ...
            expect(parseFloat(map.getElement(0)!.getAttributeValue('milliseconds.date'))).toBeCloseTo(125, 5);
        });
    });
