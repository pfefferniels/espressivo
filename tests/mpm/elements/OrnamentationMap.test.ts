...
/** a bare MSM note */
function makeNote(id: string, date: number, pitch: number, extra: Record<string, string> = {}): Element {
 ...
 */
function makePerformedNote(id: string, date: number, pitch: number, duration = 1440, velocity = 100): Element {
...
describe('OrnamentationMap', () => {
    ...
    describe('OrnamentData', () => {
        ...
        it('should parse the xml:id from XML', () => {
            ...
            xml.addAttribute(new Attribute('xml:id', 'http://www.w3.org/XML/1998/namespace', 'orn-xml-1'));
    ...
    describe('renderOrnamentationToMap', () => {
        ...
        it('should render all three reference ornaments over one score', () => {
            const notes = [
                makePerformedNote('n1', 0, 60), makePerformedNote('n2', 0, 64), makePerformedNote('n3', 0, 67),
                makePerformedNote('n4', 1440, 62), makePerformedNote('n5', 1440, 65), makePerformedNote('n6', 1440, 69),
                makePerformedNote('n7', 2880, 64), makePerformedNote('n8', 2880, 67), makePerformedNote('n9', 2880, 71),
                makePerformedNote('n10', 4320, 65), makePerformedNote('n11', 4320, 69), makePerformedNote('n12', 4320, 72),
            ];
    ...
    describe('non-milliseconds modifier rendering', () => {
        ...
        it('should shorten duration.perf when the note off does not shift', () => {
            const n = makeNote('n1', 0, 60, {
                'ornament.date.offset': '22', 'date.perf': '0',
                'duration.perf': '1440', 'date.end.perf': '1440',
            });
            modifierOnlyMap().renderOrnamentationToMap(makeScore([n]));
        ...
        it('should move date.end.perf when ornament.noteoff.shift is set', () => {
            const n = makeNote('n1', 0, 60, {
                'ornament.date.offset': '22', 'ornament.noteoff.shift': 'true',
                'date.perf': '0', 'duration.perf': '1440', 'date.end.perf': '1440',
            });
            modifierOnlyMap().renderOrnamentationToMap(makeScore([n]));
        ...
        it('should survive a note-off shift on a note without date.end.perf', () => {
            const n = makeNote('n1', 0, 60, {
                'ornament.date.offset': '22', 'ornament.noteoff.shift': 'true', 'date.perf': '0',
            });
        ...
        it('should apply an absolute ornament.duration to duration.perf and date.end.perf', () => {
            const n = makeNote('n1', 0, 60, {
                'ornament.date.offset': '30', 'ornament.duration': '300',
                'date.perf': '1440', 'duration.perf': '1440', 'date.end.perf': '2880',
            });
            modifierOnlyMap().renderOrnamentationToMap(makeScore([n]));
        ...
        it('should create duration.perf and date.end.perf when they are missing', () => {
            const n = makeNote('n1', 0, 60, {
                'ornament.date.offset': '30', 'ornament.duration': '300', 'date.perf': '1440',
            });
            modifierOnlyMap().renderOrnamentationToMap(makeScore([n]));
    ...
    describe('renderMillisecondsModifiersToMap', () => {
        ...
        it('should do nothing when either argument is null', () => {
            ...
            expect(() => OrnamentationMap.renderMillisecondsModifiersToMap(makeScore([]), null)).not.toThrow();
        ...
        it('should offset milliseconds.date', () => {
            const n = makeNote('n1', 0, 60, {
                'milliseconds.date': '2000', 'ornament.milliseconds.date.offset': '-30',
            });
            OrnamentationMap.renderMillisecondsModifiersToMap(makeScore([n]), ornMap());
        ...
        it('should apply an absolute ornament.milliseconds.duration', () => {
            const n = makeNote('n1', 0, 60, {
                'milliseconds.date': '2000', 'milliseconds.date.end': '3000',
                'ornament.milliseconds.date.offset': '-30', 'ornament.milliseconds.duration': '100',
            });
            OrnamentationMap.renderMillisecondsModifiersToMap(makeScore([n]), ornMap());
        ...
        it('should create milliseconds.date.end when it is missing', () => {
            const n = makeNote('n1', 0, 60, {
                'milliseconds.date': '2000', 'ornament.milliseconds.duration': '250',
            });
            OrnamentationMap.renderMillisecondsModifiersToMap(makeScore([n]), ornMap());
        ...
        it('should shift milliseconds.date.end when the note off shifts', () => {
            const n = makeNote('n1', 0, 60, {
                'milliseconds.date': '2000', 'milliseconds.date.end': '3000',
                'ornament.milliseconds.date.offset': '30', 'ornament.noteoff.shift': 'true',
            });
            OrnamentationMap.renderMillisecondsModifiersToMap(makeScore([n]), ornMap());
    ...
    describe('renderGlobalOrnamentationToParts', () => {
        ...
        it('should do nothing for a null or empty ornamentationMap', () => {
            ...
            OrnamentationMap.renderGlobalOrnamentationToParts([part], OrnamentationMap.createOrnamentationMap()!);
        ...
        it('should skip parts that have no dated/score subtree', () => {
            ...
            expect(() => OrnamentationMap.renderGlobalOrnamentationToParts([bare, datedOnly], map)).not.toThrow();
        });
    ...
    describe('OrnamentData.apply', () => {
        ...
        it('should apply both transformers of the def', () => {
            ...
            const n1 = makeNote('n1', 0, 60), n2 = makeNote('n2', 0, 64), n3 = makeNote('n3', 0, 67);
        ...
        it('should apply only the dynamics gradient when there is no temporal spread', () => {
            ...
            const n1 = makeNote('n1', 0, 60), n2 = makeNote('n2', 0, 64);
            od.apply([[n1], [n2]]);
