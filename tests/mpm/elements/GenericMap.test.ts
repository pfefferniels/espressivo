...
describe('GenericMap', () => {
    ...
    describe('binary search with two elements', () => {
        ...
        it('getElementIndexBeforeAt: before first', () => { expect(map.getElementIndexBeforeAt(50)).toBe(-1); });
        it('getElementIndexBeforeAt: at first', () => { expect(map.getElementIndexBeforeAt(100)).toBe(0); });
        it('getElementIndexBeforeAt: between', () => { expect(map.getElementIndexBeforeAt(200)).toBe(0); });
        it('getElementIndexBeforeAt: at second', () => { expect(map.getElementIndexBeforeAt(300)).toBe(1); });
        it('getElementIndexBeforeAt: after second', () => { expect(map.getElementIndexBeforeAt(999)).toBe(1); });

        it('getElementIndexBefore: before first', () => { expect(map.getElementIndexBefore(50)).toBe(-1); });
        it('getElementIndexBefore: at first', () => { expect(map.getElementIndexBefore(100)).toBe(-1); });
        it('getElementIndexBefore: between', () => { expect(map.getElementIndexBefore(200)).toBe(0); });
        it('getElementIndexBefore: at second', () => { expect(map.getElementIndexBefore(300)).toBe(0); });
        it('getElementIndexBefore: after second', () => { expect(map.getElementIndexBefore(999)).toBe(1); });

        it('getElementIndexAfter: before first', () => { expect(map.getElementIndexAfter(50)).toBe(0); });
        it('getElementIndexAfter: at first', () => { expect(map.getElementIndexAfter(100)).toBe(1); });
        it('getElementIndexAfter: between', () => { expect(map.getElementIndexAfter(200)).toBe(1); });
        it('getElementIndexAfter: at second', () => { expect(map.getElementIndexAfter(300)).toBe(-1); });
        it('getElementIndexAfter: after second', () => { expect(map.getElementIndexAfter(999)).toBe(-1); });

        it('getElementIndexAtAfter: before first', () => { expect(map.getElementIndexAtAfter(50)).toBe(0); });
        it('getElementIndexAtAfter: at first', () => { expect(map.getElementIndexAtAfter(100)).toBe(0); });
        it('getElementIndexAtAfter: between', () => { expect(map.getElementIndexAtAfter(200)).toBe(1); });
        it('getElementIndexAtAfter: at second', () => { expect(map.getElementIndexAtAfter(300)).toBe(1); });
        it('getElementIndexAtAfter: after second', () => { expect(map.getElementIndexAtAfter(999)).toBe(-1); });
    });
});
