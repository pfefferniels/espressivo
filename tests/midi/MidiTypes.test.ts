...
import { ShortMessage, MetaMessage, SysexMessage, MidiEvent, Track, Sequence } from '../../src/midi/MidiTypes.js';
...
describe('Track', () => {
    ...
    it('should keep the events sorted by tick regardless of insertion order', () => {
        ...
        expect([track.get(0).getTick(), track.get(1).getTick(), track.get(2).getTick()]).toEqual([0, 480, 960]);
